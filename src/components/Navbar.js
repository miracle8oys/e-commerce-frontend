        ...
        <div className='bg-orange-50 md:font-display md:text-yellow-800 border-b-[1.5px]'>
            ...
            <div className={(navbarToggle ? "absolute flex justify-center bg-orange-50 border-b-[1.4px] w-full" : "hidden")}>
                <ul className='ml-8 my-2 text-stone-900 md:hidden font-medium'>
                    ...
                    <li className='py-1 hover:bg-gray-200 rounded-md  font-sans hover:py-2 px-2 flex justify-center'>
                        <NavLink to="/cart" className='hover:font-bold'><AiOutlineShoppingCart className='text-3xl' /></NavLink>
                    </li>
                    <li className='py-1 hover:bg-gray-200 rounded-md  font-sans hover:py-2 px-2 flex justify-center'>
                        <NavLink to="/transaction" className='hover:font-bold'><BsBell className='text-3xl' /></NavLink>
                    </li>
                    {!user ? 
